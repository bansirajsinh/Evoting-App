...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _hostDeviceConnection() async {
    try {
      await _authService.hostDeviceConnection();
      debugPrint('Device connection hosted successfully');
    } catch (e) {
      debugPrint('Failed to host device connection: $e');
    }
  ...
  Future<void> _connectBlockchain() async {
    ...
    debugPrint('\x1B[32m'
    'lib/user/home.dart: _connectBlockchain() executed'
    '\x1B[0m');
  ...
  void _logout() async {
    ...
    debugPrint('\x1B[32m'
    'lib/user/home.dart: _logout() executed'
    '\x1B[0m');
  ...
  Widget _buildBody() {
    switch (_currentIndex) {
      ...
      case 1:
        return StreamBuilder<List<Election>>(
          ...
          builder: (context, snapshot) {
            ...
            if (snapshot.hasError) {
              return const Center(child: Text('Error loading elections'));
            }
        ...
        ); // handle stream inside VotingPage 
      case 2:
  ...
  return StreamBuilder<List<Election>>(
    ...
    builder: (context, snapshot) {
      ...
      final upcomingElections = allElections
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        user?.constituency ?? 'Not specified',
                        style: TextStyle(
            ...
            if (activeElections.isNotEmpty) ...[
              ...
              ...activeElections.map((e) => _buildElectionCard(e, true)),
            ],
            ...
            if (upcomingElections.isNotEmpty) ...[
              ...
              const SizedBox(height: 12),
              ...upcomingElections.map((e) => _buildElectionCard(e, false)),
            ],
          ],
        ),
      );
  ...
  Widget _buildElectionCard(Election election, bool isActive) {
    return Container(
                    ...
                    Expanded(
                      child: Text(
                        isActive
                            ...
                            : 'Starts: ${_formatDate(election.startDate)}',
                        style: AppTextStyles.caption,
                      ),
                    ),
                    if (isActive)
